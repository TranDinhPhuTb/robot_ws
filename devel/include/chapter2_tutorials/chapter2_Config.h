...
namespace chapter2_tutorials
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(chapter2_Config &config, const chapter2_Config &max, const chapter2_Config &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const chapter2_Config &config1, const chapter2_Config &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, chapter2_Config &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const chapter2_Config &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, chapter2_Config &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const chapter2_Config &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const chapter2_Config &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, chapter2_Config &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.size = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(chapter2_Config::AbstractParamDescriptionConstPtr(new chapter2_Config::ParamDescription<int>("size", "int", 0, "Select from the  list", "{'enum': [{'name': 'Low', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/phu/robot_ws/src/chapter2_tutorials/cfg/chapter2.cfg', 'description': 'Low is 0', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/phu/robot_ws/src/chapter2_tutorials/cfg/chapter2.cfg', 'description': 'Medium is  1', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'High', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/phu/robot_ws/src/chapter2_tutorials/cfg/chapter2.cfg', 'description': 'High is 2', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Select from the list'}", &chapter2_Config::size)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 11 "/home/phu/robot_ws/src/chapter2_tutorials/cfg/chapter2.cfg"
      const int chapter2__Low = 0;
//#line 12 "/home/phu/robot_ws/src/chapter2_tutorials/cfg/chapter2.cfg"
      const int chapter2__Medium = 1;
//#line 13 "/home/phu/robot_ws/src/chapter2_tutorials/cfg/chapter2.cfg"
