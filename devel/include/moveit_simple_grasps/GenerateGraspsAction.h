...
bool operator==(const ::moveit_simple_grasps::GenerateGraspsAction_<ContainerAllocator1> & lhs, const ::moveit_simple_grasps::GenerateGraspsAction_<ContainerAllocator2> & rhs)
{
