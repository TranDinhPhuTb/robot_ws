...
bool operator==(const ::moveit_simple_grasps::GenerateGraspsGoal_<ContainerAllocator1> & lhs, const ::moveit_simple_grasps::GenerateGraspsGoal_<ContainerAllocator2> & rhs)
{
