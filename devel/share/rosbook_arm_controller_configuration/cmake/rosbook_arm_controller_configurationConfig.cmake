...
if("TRUE" STREQUAL "TRUE")
  set(rosbook_arm_controller_configuration_SOURCE_PREFIX /home/phu/robot_ws/src/chapter7_tutorials/rosbook_arm_controller_configuration)
  set(rosbook_arm_controller_configuration_DEVEL_PREFIX /home/phu/robot_ws/devel)
  ...
  set(rosbook_arm_controller_configuration_INSTALL_PREFIX /home/phu/robot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbook_arm_controller_configuration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/phu/robot_ws/src/chapter7_tutorials/rosbook_arm_controller_configuration/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosbook_arm_controller_configuration_NUM_DUMMY_TARGETS)
      set(rosbook_arm_controller_configuration_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosbook_arm_controller_configuration::wrapped-linker-option${rosbook_arm_controller_configuration_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosbook_arm_controller_configuration_NUM_DUMMY_TARGETS "${rosbook_arm_controller_configuration_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosbook_arm_controller_configuration::wrapped-linker-option${rosbook_arm_controller_configuration_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosbook_arm_controller_configuration_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rosbook_arm_controller_configuration_EXPORTED_TARGETS ${${rosbook_arm_controller_configuration_dep}_EXPORTED_TARGETS})
endforeach()
