...
(cl:defmethod cl:initialize-instance :after ((m <GenerateGraspsFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GenerateGraspsFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_simple_grasps-msg:<GenerateGraspsFeedback> is deprecated: use moveit_simple_grasps-msg:GenerateGraspsFeedback instead.")))

(cl:ensure-generic-function 'grasps-val :lambda-list '(m))
(cl:defmethod grasps-val ((m <GenerateGraspsFeedback>))
